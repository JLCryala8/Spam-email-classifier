...
test_message = "Congratulations! You've won a free ticket to the concert. Click here to claim your prize."
...
spam_tokens = ['helvetica', 'congratulations', 'list', 'free', 'click', 'image', 'get', 'please', 'send', 'gif','claim', 'ticket','prize', 'win', 'won.']
...
user_message = "I kind of just want to go to a party with you"
